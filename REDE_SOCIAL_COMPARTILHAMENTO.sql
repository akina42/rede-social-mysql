...
CREATE TABLE `COMPARTILHAMENTO` (
  ...
  CONSTRAINT `COMPARTILHAMENTO_ibfk_1` FOREIGN KEY (`ID_POSTAGEM`) REFERENCES `POSTAGEM` (`ID`),
  CONSTRAINT `COMPARTILHAMENTO_ibfk_2` FOREIGN KEY (`ID_PESSOA`) REFERENCES `PESSOA` (`ID`)
...
INSERT INTO `COMPARTILHAMENTO` VALUES (1,'Compartilhando com vcs!',1,2);
